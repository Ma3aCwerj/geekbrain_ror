class Moderator::UsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user.save
        format.html { redirect_to [:moderator,@user], notice: 'User was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @user.update(user_params)
        format.html { redirect_to [:moderator,@user], notice: 'User was successfully updated.' }
  ...
  def destroy
    @user.destroy
    respond_to do |format|
      format.html { redirect_to moderator_users_path, notice: 'User was successfully destroyed.' }
